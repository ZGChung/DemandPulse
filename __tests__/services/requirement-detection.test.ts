...
describe('RequirementDetectionService', () => {
  ...
  describe('summarizeRequirement', () => {
    it('should summarize requirement text', () => {
      const text = 'I need to build a tool that automates database backups. This tool should run daily and send notifications if backups fail. It should also compress the backups to save storage space.'
    ...
    it('should handle very long first sentence', () => {
      const longSentence = 'I want to create a comprehensive data analytics platform that integrates with multiple data sources, provides real-time dashboards, supports custom reporting, includes machine learning predictions, and offers API access for third-party integrations, all while maintaining high performance and scalability.'
