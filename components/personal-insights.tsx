  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className={`px-3 py-1 rounded-full text-sm font-medium flex items-center gap-2 ${badge.color}`}>
          {badge.icon}
          {badge.title}
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        {contributionCount === 0 && (
          <div className="p-4 bg-blue-50 rounded-lg">
            <p className="text-sm text-blue-800 font-medium mb-2">Ready to make your first contribution?</p>
        ...
        <div className="pt-4 border-t border-gray-200">
          <p className="text-sm text-gray-600">
            <span className="font-medium">Community impact:</span> Each requirement you share helps developers identify emerging trends and build better tools.
          </p>
        </div>
      </div>
    </div>
