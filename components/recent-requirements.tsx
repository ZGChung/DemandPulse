...
export default function RecentRequirements() {
  ...
  const fetchRequirements = async () => {
    try {
      ...
      const mockRequirements: Requirement[] = [
        {
          id: 'req_001',
          originalRequirement: 'Need a real-time dashboard for monitoring AI model performance with customizable widgets',
        ...
        {
          id: 'req_002',
          originalRequirement: 'Implement authentication system with OAuth, JWT, and role-based access control',
        ...
        {
          id: 'req_003',
          originalRequirement: 'Create database backup automation with encryption and cloud storage integration',
        ...
        {
          id: 'req_004',
          originalRequirement: 'Build notification system with email, Slack, and push notification support',
        ...
        {
          id: 'req_005',
          originalRequirement: 'Design responsive mobile UI with dark mode support and accessibility features',
  ...
  const getCategoryFromRequirement = (requirement: Requirement): string => {
    ...
    if (text.includes('dashboard') || text.includes('analytics') || text.includes('visualization')) {
    ...
    if (text.includes('ui') || text.includes('ux') || text.includes('interface') || text.includes('mobile')) {
      return 'UI/UX'
    }
    return 'General'
  }
